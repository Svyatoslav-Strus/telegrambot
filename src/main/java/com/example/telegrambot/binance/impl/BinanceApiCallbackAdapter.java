...
import com.example.telegrambot.binance.BinanceApiError;
...
import static com.example.telegrambot.binance.impl.BinanceApiServiceGenerator.getBinanceApiError;

/**
 * An adapter/wrapper which transforms a Callback from Retrofit into a BinanceApiCallback which is exposed to the binance.
 */
