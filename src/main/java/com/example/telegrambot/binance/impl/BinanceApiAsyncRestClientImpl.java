...
import com.example.telegrambot.binance.BinanceApiAsyncRestClient;
...
import com.example.telegrambot.binance.domain.account.Account;
import com.example.telegrambot.binance.domain.account.DepositAddress;
import com.example.telegrambot.binance.domain.account.DepositHistory;
import com.example.telegrambot.binance.domain.account.NewOrder;
import com.example.telegrambot.binance.domain.account.NewOrderResponse;
import com.example.telegrambot.binance.domain.account.Order;
import com.example.telegrambot.binance.domain.account.Trade;
import com.example.telegrambot.binance.domain.account.WithdrawHistory;
import com.example.telegrambot.binance.domain.account.request.AllOrdersRequest;
import com.example.telegrambot.binance.domain.account.request.CancelOrderRequest;
import com.example.telegrambot.binance.domain.account.request.OrderRequest;
import com.example.telegrambot.binance.domain.account.request.OrderStatusRequest;
import com.example.telegrambot.binance.domain.event.ListenKey;
import com.example.telegrambot.binance.domain.general.ServerTime;
import com.example.telegrambot.binance.domain.market.AggTrade;
import com.example.telegrambot.binance.domain.market.BookTicker;
...
import com.example.telegrambot.binance.domain.market.OrderBook;
import com.example.telegrambot.binance.domain.market.TickerPrice;
import com.example.telegrambot.binance.domain.market.TickerStatistics;

import java.util.List;

import static com.example.telegrambot.binance.impl.BinanceApiServiceGenerator.createService;
